...
local function HeartbeatUpdate()
	...
	FpsLabel.Text = ("基沃托斯时间:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
Start = tick()
...
about:Button("我用紫沙",function()
game.Players.LocalPlayer.Character.Humanoid.Health = 0
HumanDied = true
end)

about:Slider("最大血量", "MaxHealth", game.Players.LocalPlayer.Character.Humanoid.MaxHealth, 100, 10000, false, function(MaxHealth)
  spawn(function() while task.wait() do game.Players.LocalPlayer.Character.Humanoid.MaxHealth = MaxHealth end end)
end)

about:Slider("当前血量", "MaxHealth", game.Players.LocalPlayer.Character.Humanoid.Health, 100, 10000, false, function(Health)
  spawn(function() while task.wait() do game.Players.LocalPlayer.Character.Humanoid.Health = Health end end)
end)
